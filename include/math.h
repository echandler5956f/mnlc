...
namespace DStarLite
{
	...
	public:
		 ...
		 * @return bool
		 */
		static bool equals(double a, double b, double precision = 0.00000001);
		 ...
		 * @return bool
		 */
		static bool greater(double a, double b, double precision = 0.00000001);
		 ...
		 * @return bool
		 */
		static bool less(double a, double b, double precision = 0.00000001);
